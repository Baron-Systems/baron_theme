...
window.onload = async () => {
  ...
  dropdownContainer.className = "baron-workspace-dropdown-container";

  // HTML structure with the button and menu wrapper
  dropdownContainer.innerHTML = `
    <button id="dropdownButton" class="baron-dropdown-button" aria-label="Toggle workspaces menu">
     <svg class="icon icon-md baron-workspace-menu-icon" aria-hidden="true"><use href="#icon-image-view"></use></svg>
    </button>
    <div class="baron-dropdown-menu" id="dropdownMenu">
  ...
  pages.forEach((page) => {
    ...
    li.className = "baron-dropdown-item";
    li.textContent = page.title;

    const iconSpan = document.createElement("span");
    iconSpan.className = "baron-dropdown-item-icon";
